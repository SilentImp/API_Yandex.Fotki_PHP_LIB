<?php
	...
	- написать плагин для WP. "ну можно сделать отображение всей галереи, только указанной или только указанной фотки из какой-нить галереи", "ну и красивый выбор фотки для вставки как у WP-Gallery", "и лайтбокс, как у фб" 
	*/

	...
	*/
	class yandex_fotki_user{
		...
		*/
		...
		//! Позволяет установить и и получить токен пользователя, подтверждающий его аутентификацию.
		/*!
			@param token Если задан, устанавливает токен. Не обязательный параметр.
